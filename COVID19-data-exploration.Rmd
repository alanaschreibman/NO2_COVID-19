...
ggplot(data = owid.countries, aes(x = fem.smokers, y = totcases.mil)) +
  ...
  labs(title = "World COVID-19 Cases per Million People in  vs. Percentage of Female Smokers") #COVID-19 cases vs. female smokers on world scale. 
cor(owid.countries$totcases, owid.countries$fem.smokers, use = "complete.obs") 
